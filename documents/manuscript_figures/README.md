...
**37 panels collected · 6 have no figure yet · 0 expected file missing**
...
| `Fig1E_RL_model_behaviour` | `Striatum project/rl_model/figures/fig_behaviour.png` | png | RL model reproduces behaviour |
...
| `Fig3C_ensemble_area_composition` | `Striatum project/figures/ensemble_area_composition.png` | png | Anatomical distribution of ensembles |
| `Fig3C_ensemble_type_composition` | `Striatum project/figures/ensemble_unittype_composition.png` | png | Cell-type composition of ensembles |
| `Fig3C_ensemble_area_type_composition` | `Striatum project/figures/ensemble_area_unittype_composition.png` | png | Joint area x cell-type composition |
...
| `Fig3E_RL_latents` | `Striatum project/rl_model/figures/fig_example_latents.png` | png | RL internal variables (value, RPE, precision) |
| `Fig3E_neural_encoding_of_latents` | `Striatum project/rl_model/figures/fig_neural_encoding.png` | png | Ensemble activity vs RL latents (NOT yet run on current latents) |
...
| `Fig4D_gini_across_learning_spatial` | `Striatum project/cca/figures/stage3_gini_committed.png` | png | Gini across learning, spatial arm |
