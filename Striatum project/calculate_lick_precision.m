function [p, shuffled_lick_precision_mean, shuffled_lick_precision_sem, chance_quantile] = calculate_lick_precision(l, rz_start)
...
shuffled_lick_precision_sem = nan;
chance_quantile = nan;
...
if lick_number > 0
    ...
    shuffled_lick_precision_sem = sem(shuffled_lick_precision);
