function trialData = cut_data_per_trial(all_data, ianimal)
    ...
    trial_lick_positions = cellfun(@(x, y) x(logical(y)), trial_position, trial_licks, 'UniformOutput', false);
    ...
    trialData = struct('n_trials', n_trials, 'trialStartTimes_vr', trialStartTimes_vr, ...
        ...
        'trial_position', {trial_position}, 'trial_lick_positions', {trial_lick_positions}, 'trial_reward', {trial_reward}, ...
